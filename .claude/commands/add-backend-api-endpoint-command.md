---
name: add-backend-api-endpoint-command
description: Workflow command scaffold for add-backend-api-endpoint-command in lolmuse.
allowed_tools: ["Bash", "Read", "Write", "Grep", "Glob"]
---

# /add-backend-api-endpoint-command

Use this workflow when working on **add-backend-api-endpoint-command** in `lolmuse`.
